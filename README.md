...
A repository containing study materials for technical interviews.
...
# Run a JavaScript fundamentals file
npm run js javascript-fundamentals/closures.js

# Run an architecture example
